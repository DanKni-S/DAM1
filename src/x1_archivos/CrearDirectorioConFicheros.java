...
public class CrearDirectorioConFicheros {
	...
	public static void main(String[] args) {
		...
		try { 
			...
			if (directorio.mkdir()) {
				System.out.println("Directorio DIR creado con éxito.");
			}
			else {
			...
			if (fichero1.createNewFile()) {
				System.out.println("Fichero FICH1.TXT creado con éxito.");
			}
			else {
			...
			if (fichero2.createNewFile()) {
				System.out.println("Fichero FICH2.TXT creado con éxito.");
			}
			else {
			...
			if (fichero1.renameTo(ficheroRenombrado)) {
				System.out.println("Fichero FICH1.TXT renombrado con éxito.");
			}
			else {
			...
			if (fichero2.delete()) {
				System.out.println("Fichero FICH2.TXT eliminado con éxito.");
			}
			else {
